...
{
    public const string MAVLINK_BUILD_DATE = "Wed May 12 2021";
    ...
    public static message_info[] MAVLINK_MESSAGE_INFOS = new message_info[] {
        ...
        new message_info(19, "PARAM_ACK_TRANSACTION", 137, 24, 24, typeof( mavlink_param_ack_transaction_t )), // none 24 bit
        ...
        new message_info(52, "MISSION_CHANGED", 132, 7, 7, typeof( mavlink_mission_changed_t )), // none 24 bit
    ...
    {
        ///<summary> General information which also includes information on other optional supported COMP_METADATA_TYPE's. Must be supported. Only downloadable from vehicle. | </summary>
        [Description("General information which also includes information on other optional supported COMP_METADATA_TYPE's. Must be supported. Only downloadable from vehicle.")]
        GENERAL=0, 
        ///<summary> Parameter meta data. | </summary>
        [Description("Parameter meta data.")]
        PARAMETER=1, 
        ///<summary> Meta data which specifies the commands the vehicle supports. (WIP) | </summary>
        [Description("Meta data which specifies the commands the vehicle supports. (WIP)")]
        COMMANDS=2, 
        ///<summary> Meta data which specifies potential external peripherals that do not talk MAVLink | </summary>
        [Description("Meta data which specifies potential external peripherals that do not talk MAVLink")]
        PERIPHERALS=3, 
        ///<summary> Meta data for events interface | </summary>
        [Description("Meta data for events interface")]
        EVENTS=4, 
        
    };
    
    ///<summary> Possible transport layers to set and get parameters via mavlink during a parameter transaction. </summary>
    public enum PARAM_TRANSACTION_TRANSPORT: int /*default*/
    {
    ...
    ///<summary> Possible parameter transaction actions. </summary>
    public enum PARAM_TRANSACTION_ACTION: int /*default*/
    {
    ...
    public enum MAV_CMD: ushort
    {
        ...
        ///<summary> Start orbiting on the circumference of a circle defined by the parameters. Setting any value NaN results in using defaults. |Radius of the circle. positive: Orbit clockwise. negative: Orbit counter-clockwise.| Tangential Velocity. NaN: Vehicle configuration default.| Yaw behavior of the vehicle.| Reserved (e.g. for dynamic center beacon options)| Center point latitude (if no MAV_FRAME specified) / X coordinate according to MAV_FRAME. NaN: Use current vehicle position or current center if already orbiting.| Center point longitude (if no MAV_FRAME specified) / Y coordinate according to MAV_FRAME. NaN: Use current vehicle position or current center if already orbiting.| Center point altitude (MSL) (if no MAV_FRAME specified) / Z coordinate according to MAV_FRAME. NaN: Use current vehicle position or current center if already orbiting.|  </summary>
    ...
    ///<summary> Response from a PARAM_SET message when it is used in a transaction. </summary>
    public struct mavlink_param_ack_transaction_t
    {
        public mavlink_param_ack_transaction_t(float param_value,byte target_system,byte target_component,byte[] param_id,/*MAV_PARAM_TYPE*/byte param_type,/*PARAM_ACK*/byte param_result) 
        {
        ...
        /// <summary>Parameter value (new value if PARAM_ACCEPTED, current value otherwise)   </summary>
        [Units("")]
        [Description("Parameter value (new value if PARAM_ACCEPTED, current value otherwise)")]
        public  float param_value;
            /// <summary>Id of system that sent PARAM_SET message.   </summary>
        [Units("")]
		...
		public byte[] param_id;
            /// <summary>Parameter type. MAV_PARAM_TYPE  </summary>
        [Units("")]
    ...
    {
        public mavlink_highres_imu_t(ulong time_usec,float xacc,float yacc,float zacc,float xgyro,float ygyro,float zgyro,float xmag,float ymag,float zmag,float abs_pressure,float diff_pressure,float pressure_alt,float temperature,ushort fields_updated) 
        {
              this.time_usec = time_usec;
              this.xacc = xacc;
              this.yacc = yacc;

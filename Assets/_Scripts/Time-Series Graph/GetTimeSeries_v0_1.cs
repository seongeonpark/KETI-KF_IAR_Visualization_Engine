...
public class GetTimeSeries_v0_1 : MonoBehaviour
{
    private List<_ID_xmlCon> _requestIDs_xmlCons = new List<_ID_xmlCon>();
    private _ID_xmlCon _received_latest;
    ...
    private Window_Graph _graphMaker;

    // Start is called before the first frame update
    void Start()
    {
        _graphMaker = GameObject.Find("Window_Graph").GetComponent<Window_Graph>();
    ...
    IEnumerator GetTimeSeries()
    {
        while(true)
        {
            ...
            _graphMaker._timeSeries = _requestIDs_xmlCons;
        }
    }
}
